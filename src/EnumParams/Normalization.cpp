...
std::string Normalization::getClassName() { return "Normalization"; }

QString Normalization::toString() const {
  switch (m_Type) {
    case enu_normalization::batchnorm1d : return "BatchNorm1d";
    case enu_normalization::layernorm   : return "LayerNorm";
    default                             : return "";
  }
}
